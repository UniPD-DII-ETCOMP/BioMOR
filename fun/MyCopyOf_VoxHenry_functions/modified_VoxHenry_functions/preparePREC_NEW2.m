...
%%
function [A_inv,LL,UU,PP,QQ,RR,Sch_comp] =  preparePREC_NEW2(...
    rloc,idxFx,idxFy,idxFz,...
...
diag_pulse(1:num_currx,1)                                        =1./(rloc(1:num_currx) + st_sparse_preconL(1));
diag_pulse(num_currx+1:num_currx+num_curry,1)                    =1./(rloc(num_currx+1:num_currx+num_curry) + st_sparse_preconL(2));
diag_pulse(num_currx+num_curry+1:num_currx+num_curry+num_currz,1)=1./(rloc(num_currx+num_curry+1:num_currx+num_curry+num_currz) + st_sparse_preconL(3));
